...
public:
    ...
    QAction *helpPolycrankAction;
    QAction *fileImport_Human_HandAction;
    QAction *dynamicsArch_BuilderAction;
    QAction *PolycrankPanelAction;
    QAction *PolycrankSaverAction;
    QAction *PolycrankPlayerAction;
    ...
    void setupUi(Q3MainWindow *MainWindowUI)
    {
        ...
        helpPolycrankAction = new QAction(MainWindowUI);
        helpPolycrankAction->setObjectName(QString::fromUtf8("helpPolycrankAction"));
        helpPolycrankAction->setName("helpPolycrankAction");
        ...
        PolycrankPanelAction = new QAction(MainWindowUI);
        PolycrankPanelAction->setObjectName(QString::fromUtf8("PolycrankPanelAction"));
        PolycrankPanelAction->setName("PolycrankPanelAction");
        PolycrankSaverAction = new QAction(MainWindowUI);
        PolycrankSaverAction->setObjectName(QString::fromUtf8("PolycrankSaverAction"));
        PolycrankSaverAction->setName("PolycrankSaverAction");
        PolycrankPlayerAction = new QAction(MainWindowUI);
        PolycrankPlayerAction->setObjectName(QString::fromUtf8("PolycrankPlayerAction"));
        PolycrankPlayerAction->setName("PolycrankPlayerAction");
        ...
        actionIRp6_server = new QAction(MainWindowUI);
        actionIRp6_server->setObjectName(QString::fromUtf8("actionIRp6_server"));
        ...
        Polycrank = new QMenu(menubar);
        Polycrank->setObjectName(QString::fromUtf8("Polycrank"));
        ...
        menubar->addAction(Polycrank->menuAction());
        ...
        Misc->addSeparator();
        Misc->addAction(actionIRp6_server);
        Polycrank->addAction(PolycrankPanelAction);
        Polycrank->addSeparator();
        Polycrank->addAction(PolycrankSaverAction);
        Polycrank->addSeparator();
        Polycrank->addAction(PolycrankPlayerAction);
        helpMenu->addAction(helpManualAction);
        helpMenu->addSeparator();
        helpMenu->addAction(helpAboutAction);
        helpMenu->addAction(helpAboutQTAction);
        helpMenu->addAction(helpPolycrankAction);
    ...
    void retranslateUi(Q3MainWindow *MainWindowUI)
    {
        ...
        helpPolycrankAction->setIconText(QApplication::translate("MainWindowUI", "Polycrank", 0, QApplication::UnicodeUTF8));
        helpPolycrankAction->setText(QApplication::translate("MainWindowUI", "Polycrank &...", 0, QApplication::UnicodeUTF8));
        ...
        PolycrankPanelAction->setIconText(QApplication::translate("MainWindowUI", "Connect with MRROC++", 0, QApplication::UnicodeUTF8));
        PolycrankPanelAction->setText(QApplication::translate("MainWindowUI", "Connect with MRROC++", 0, QApplication::UnicodeUTF8));
        PolycrankSaverAction->setIconText(QApplication::translate("MainWindowUI", "Save interpolation positions", 0, QApplication::UnicodeUTF8));
        PolycrankSaverAction->setText(QApplication::translate("MainWindowUI", "Save interpolation positions", 0, QApplication::UnicodeUTF8));
        PolycrankPlayerAction->setIconText(QApplication::translate("MainWindowUI", "Play trajectory", 0, QApplication::UnicodeUTF8));
        PolycrankPlayerAction->setText(QApplication::translate("MainWindowUI", "Play trajectory", 0, QApplication::UnicodeUTF8));
        ...
        actionIRp6_server->setText(QApplication::translate("MainWindowUI", "IRp6 Server Start", 0, QApplication::UnicodeUTF8));
        ...
        Polycrank->setTitle(QApplication::translate("MainWindowUI", "Polycrank", 0, QApplication::UnicodeUTF8));
