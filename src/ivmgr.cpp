...
//
// $Id: ivmgr.cpp,v 1.63.2.1 2009/07/23 21:18:01 cmatei Exp $
//
//######################################################################
...
//#endif
	  ...
	  {
		//std::cout<<"IVmgr::handleSelection --  TRANSLATE_TOOL \n";
	    makeHandleBox(world->getBody(b),world->getBody(b));
	  }
	  else if (currTool == SELECT_TOOL) 
	  {
		//std::cout<<"IVmgr::handleSelection --  SELECT_TOOL \n";
