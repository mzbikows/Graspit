...
//
// $Id: body.cpp,v 1.68.2.2 2009/07/29 18:39:22 cmatei Exp $
//
//######################################################################
...
/*!
  ...
  We assume that the geometry file has been modified to also contain some 
  GraspIt specific information at the beginning, such as material properties.
  This information is marked as Inventor comments, so that it does not interfere
  with the geoemtry itself. We will move away from this model soon and replace it
  with an XML reader for all GraspIt specific information.
*/
int 
...
DynamicBody::computeDefaultMassProp(position &defaultCoG, double *defaultI)
{
  ...
  computeDefaultInertiaMatrix(triangles, defaultI);
